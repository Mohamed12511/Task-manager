...
## Description 
This is a simple Task Manager project with a **backend (Node.js + Express + MongoDB)** and a **frontend**.   
You can manage tasks by creating, updating, and deleting them. 
